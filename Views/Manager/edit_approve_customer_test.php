...
while ($row = mysql_fetch_array($sql)) {
    ...
    ?>
                            ...
                            <div id="ContentPlaceHolder2_viewproofs" class="box box-warning">
                                <div class="box-body">
                                    <div class="col-md-2">
                                        <h4>Address Proof</h4>
                                        <img id="ContentPlaceHolder2_imgidproof" src="../upload/<?php echo $row['IDProof1'] ?>" style="height:100px;width:100px;" />
                                    </div>
                                    <div class="col-md-2 text-left">
                                        <br><br>
                                        <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal">View</button>
                                        <br /><br />
                                        <a id="" class="links" href="download.php?filename=PHP-file-download-script.jpg"><i class="fa fa-download"></i> Download</a>
                                    </div>
                                    <!-- Address Proof modal -->  
                                    ...
                                    <div class="col-md-2">
                                        <h4>Identity card</h4>
                                        <img id="ContentPlaceHolder2_imgproof1" src="../upload/<?php echo $row['photoid'] ?>" style="height:100px;width:100px;" />
                                    </div>
                                    <div class="col-md-2 pull-left">
                                        <br ><br>
                                        <button type="button"  class="btn btn-sm btn-default" data-toggle="modal" data-target="#myModal1">View</button>
                                        <br /><br>
                                        <a id="" href=""><i class="fa fa-download"></i> Download</a>
                                    </div>
                                    ...
                                    <div class="col-md-2 text-left">
                                        ...
                                        <button type="button"  class="btn btn-sm btn-default" data-toggle="modal" data-target="#myModal1">View</button>
                                        <br><br>
                                        <a id="" href="download.php?filename=PHP-file-download-script.jpg"><i class="fa fa-download"></i> Download</a>
                                    </div>
                                </div>
                            </div> 
...
<?php include 'include/mang_script.php'; ?>
        ...
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js"></script>
        <!-- image upload -->
