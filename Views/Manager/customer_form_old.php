...
if (isset($_GET['id'])) {
    ...
    while ($row = mysql_fetch_array($sql)) {
        ?>
                        <div class="container">
                            ...
                            <section class="col-xs-12 border">
                                ...
                                <div class="col-xs-3 text-left"><strong>Date: </strong><?php echo $row['AccountDate']; ?></div><br><br> 
                                <div class="col-xs-12 text-left" style="background-color: #0073b7; color: #ffffff;">A. Personal Details</div>
                            </section>
                            <section class="col-xs-10 ">
                                <div class="row">
                                    <div class="border text-left">&emsp;<b>Name: &nbsp;</b> <?php echo $row['CustomerName']; ?></div>
                                    <div class="border text-left"><b>&emsp;Father's Name: &nbsp;</b><?php echo $row['ApplicantFather']; ?></div>
                                    <div class="border text-left height-control" style="height: 40px;">
                                        <div class="col-xs-4"><b>Date of birth : &nbsp;</b><?php echo $row['BirthDate']; ?></div> 
                                    ...
                                    <div class="border text-left"><b>&emsp;Home Address : &nbsp;</b><?php echo $row['ResAddress']; ?></div>

                                </div>
                            </section>
                            <section class="col-xs-2 border">
                                <div class="row">
                                    <div class="col-xs-2 text-center" style="height: 184px;">
        ...
        <?php
        echo '<img src="../upload/' . $row['mphoto'] . '"  style="width:160px; height:130px" />'
        ?>

                                        <?php
                                        echo '<img src="../upload/' . $row['CSign'] . '"  style="width:160px; height:50px" />'
                                        ?>
                                    </div>
                                </div>
                            </section>
                            <section class="col-xs-12">
                                <div class="row">
                                    <div class="border text-left"><b>&emsp;Work Address : &nbsp;</b><?php echo $row['OffAddress']; ?></div>
                                    <div class="border text-left height-control" style="height: 40px;">
                                    ...
                                    <div class="border text-left" >&emsp; <b>Preferred Communication Method :</b> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                            ...
                            <section class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12 text-left" style="background-color: #0073b7; color: #ffffff;">B. Document Submitted</div>
                                    <div class="border text-left height-control" style="height: 40px;">
                                    ...
                                    <div class="border col-xs-12 text-left">&emsp;<b>Remarks If Any:</b></div>
                                </div>
                            </section><br><br>
                            <section class="col-xs-12">
                                <div class="row"><br>
                                    <div class="col-xs-12 text-left" style="background-color: #0073b7; color: #ffffff;">C. Nominee Details</div>
                                    <div class="border col-xs-12 text-left form-control">&emsp;<b>Nominee Name: &nbsp;</b><?php echo $row['NomineeName']; ?></div>
                                    <div class="border col-xs-12  text-left form-control" >
                                    ...
                                    <div class="border col-xs-12 text-left">&emsp;<b>Nominee Present Address: &nbsp;</b><?php //echo $row[''];  ?></div>
                                    <div class="border col-xs-12 text-left">&emsp;<b>Nominee Permanent Address: &nbsp;</b><?php //echo $row[''];  ?></div>
                                </div>
                            </section>
                            <section class="col-xs-12">
                                <div class="row"><br>
                                    <div class="col-xs-12 text-left" style="background-color: #0073b7; color: #ffffff;"> D. Other Details</div>
                                    <div class="border col-xs-12 text-left form-control">&emsp;<b>Gross Annual Income:</b> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                    ...
                                    <div class="border col-xs-12 text-left">&emsp;<b>Any Other Information:</b></div>
                                </div>
                            </section>
                            <section class="col-xs-12">
                                <div class="row"><br>
                                    <div class="col-xs-12" style="background-color: #0073b7; color: #ffffff;">  FOR OFFICE USE ONLY </div><br><br>
                            ...
                            <section class="col-xs-12">
                                <div class="row"><br>
                                    <div class="col-xs-12" style="background-color: #0073b7; color: #ffffff;">   CUSTOMER'S DECLARATION </div><br><br>
