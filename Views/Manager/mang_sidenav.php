        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="pendingbankapplication_list.php"><i class="fa fa-user-plus"></i>Pending Application</a></li>
                            <li><a href="mang_approved_bankaccountcustomer_list.php"><i class="fa fa-check-circle-o"></i>Approve Application</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="approve_goldloan_list.php"><i class="fa fa-circle-o"></i> Approval Loan
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
            ...
            <!--  <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="loan_transaction.php"><i class="fa fa-plus-circle"></i>Loan Transaction</a></li>
            ...
            <li class="treeview">
                <a href="loan_pre_close.php">
                    <i class="fa fa-dashboard"></i> <span>Pre Closer Account</span>    
                </a>       
            </li>
