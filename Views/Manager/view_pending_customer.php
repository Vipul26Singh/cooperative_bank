...
if (isset($_POST['submit'])) {
    ...
    if (isset($approve_status) == "approve") {
        ...
        if ($sql) {
            $sqlemail = mysql_fetch_array(mysql_query("SELECT * from  customer where CustomerID='" . $_GET['id'] . "' ")) or die(mysql_error());
            ...
            $message .= "Your account is actived succesfully this is your customer No <b>$cid</b><br/><br/>";
...
<?php include 'include/mang_sidenav.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form role="form" method="post" action=""  onsubmit="validationcheck()" >
...
if (isset($_GET['id'])) {
    ...
    while ($row = mysql_fetch_array($sql)) {
        ...
        ?>
                                            ...
                                            <div class="col-md-4 space"> 
                                                <select class="form-control" name="c_approve" id="c_approve" style="width: 100%;" required>
...
<script type="text/javascript">
    ...
    {
        var c_approve = $("#c_approve").val();

        if (c_approve == 'approve')
        {
            jSuccess('Your application submited succesfully', 'Success Dialog');
        } else
        {
            jAlert('Your application is decline', 'Alert Dialog');
        }
