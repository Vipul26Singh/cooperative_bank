                        ...
                        <form role="form" method="post" action="">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php
                                    $sql = mysql_query("SELECT * from goldloanapplication ga inner join customer c on c.CustomerID=ga.CustomerID   where  GoldLoanStatus='pending' and GoldLoanStatus!='decline' ") or die(mysql_error());
                                    ?>
                                    ...
                                    <table class="table table-responsive table-condensed table-striped table-hover table-bordered">
                                        ...
                                        while ($row = mysql_fetch_array($sql)) {
                                            ...
                                            . "<td><a href='pending_loan_application.php?id=", $row['ApplyGoldLoanID'], "' '><span class='badge bg-yellow'>View</span></a></td>"
                                            . "</tr>";
                                        }
                                        ?> </table> 
                                        <?php
