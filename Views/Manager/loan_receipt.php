                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12"><br>
                            <table id="example2" class="table table-hover table-striped table-responsive">
                                ...
                                <tbody>
<?php
$sql = mysql_fetch_array(mysql_query("SELECT `Type`, `Amount` FROM `loan` WHERE LoanNumber='" . $_GET['LoanNumber'] . "' "));
echo "<tr>"
                    ...
                    <!--    <div class="box-body">  
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Loan No: <?php // echo $_GET['LoanNumber'];  ?></label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Loan Type: <?php //echo $sql['Type'];  ?></label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Customer Name: <?php //echo $_GET['CustomerName'];  ?></label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date: <?php //echo date('d-m-Y', strtotime($_GET['DepositDate']));  ?></label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Pay Amount: <?php //echo $_GET['Amount'];  ?></label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Loan Amount: <?php //echo $sql['Amount'];  ?></label>
                                </div>
                            </div>
                      </div> -->
