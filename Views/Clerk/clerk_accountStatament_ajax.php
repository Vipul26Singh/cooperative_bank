...
<script type="text/javascript">
    function accountdetails1()
    {
        ...
        window.open("clerk_account_print_ajax.php?accountno=" + accountno + "&trasactiondate=" + trasaction_date + "&trasactionmode=" + trasaction_mode + "&trasactionenddate=" + trasaction_end_date);
