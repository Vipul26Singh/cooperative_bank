                        ...
                        <form role="form" method="post" action="">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php $sql = mysql_query("SELECT CustomerID,CustomerName,MobileNo,EmailID,BirthDate,ActiveBy,AccountDate,city.CityName,userinfo.EmployeeName from customer inner join city on city.CityId=customer.CityId LEFT join userinfo on userinfo.UserId=customer.ActiveBy WHERE customer.Approval='pending' and customer.BranchId='" . $_SESSION['branch_id'] . "' ORDER BY CustomerName ASC ") or die(mysql_error());
                                    ;
                                    ?><br>
                                    <table class="table table-responsive table-condensed table-striped table-hover table-bordered">
                                        ...
                                        while ($row = mysql_fetch_array($sql)) {
                                            ...
                                            /* . "<td><a href='view_pending_customer.php?id=",$row['CustomerID'],"' '><span class='badge bg-blue'>View</span></a></td>" */
                                            . "</tr>";
                                        }
                                        ?> </table> <?php
                                        ?>
