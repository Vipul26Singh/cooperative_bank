...
<script src="../../js/jquery.min.1.11.2.js" type="text/javascript"></script>
<!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script> 
<!-- jQuery UI 1.11.4 -->
<!--<script src="https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script src="../../js/ui.1.11.4.js" type="text/javascript"></script>
<script>
...
<script src="../../js/raphael.2.1.0.js" type="text/javascript"></script>
...
<!-- daterangepicker -->
<script src="../../js/moment.min.2.11.2.js" type="text/javascript"></script>
