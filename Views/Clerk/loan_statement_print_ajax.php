...
?>          <div class="row">
                        ...
                        <div class="col-xs-4 text-center"><b>&nbsp; Loan Transaction</b></div>
...
?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label> Loan No : <?php echo $_GET['loanno']; ?></label>
                        </div>
                    </div>
...
if ($_GET['loanno'] && $_GET['trasactiondate'] && $_GET['trasactionenddate'] && $_GET['trasactionmode']) {

    $sqlaccount = mysql_query("SELECT * FROM loantransaction WHERE LoanNumber='" . $_GET['loanno'] . "' 
                                            AND (DepositDate BETWEEN '" . $startdate . "' AND '" . $enddate . "') 
                                            AND TransactionType='" . $_GET['trasactionmode'] . "' ");
...
/* * * Display Acc no and date * */ else if ($_GET['loanno'] && $_GET['trasactiondate'] && $_GET['trasactionenddate']) {

    $sqlaccount1 = mysql_query("SELECT * FROM  loantransaction WHERE LoanNumber='" . $_GET['loanno'] . "' 
                                            AND (DepositDate BETWEEN '" . $startdate . "' AND '" . $enddate . "') 
                                            OR TransactionType='" . $_GET['trasactionmode'] . "' 
                                             ");
...
/* * * Account no and cash *** */ else if ($_GET['loanno'] && $_GET['trasactionmode']) {
    $sqlaccount2 = mysql_query("SELECT * FROM loantransaction WHERE LoanNumber='" . $_GET['loanno'] . "' 
                                            AND TransactionType='" . $_GET['trasactionmode'] . "' ");
...
/* * * Account No ** */ else if ($_GET['loanno'] && empty($_GET['trasactiondate'] && $_GET['trasactionenddate'] && $_GET['trasactionmode'])) {
    $sqlaccount = mysql_query("SELECT * FROM  loantransaction WHERE LoanNumber='" . $_GET['loanno'] . "' 
                                            OR (DepositDate BETWEEN '" . $startdate . "' AND '" . $enddate . "') 
                                            OR TransactionType='" . $_GET['trasactionmode'] . "' ") or die(mysql_error());
