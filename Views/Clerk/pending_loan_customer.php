                        ...
                        <form role="form" method="post" action="">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php
                                    $sql = mysql_query("SELECT * from goldloanapplication ga inner join customer c on c.CustomerID=ga.CustomerID   where  GoldLoanStatus='pending' ") or die(mysql_error());
                                    ?>
