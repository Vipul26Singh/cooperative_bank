            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="add_gold_loan.php">

                            <div class="box-header with-border text-center">
                                <input type="submit" name="add" class="btn btn-primary" value="Add Gold Loan">
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">

                                    <?php
                                    $sql = mysql_query("SELECT g.*,b.*,c.CustomerName,c.CustomerID FROM `goldloanapplication` g
                                            INNER JOIN userinfo u ON u.BranchId=g.BranchId 
                                            INNER JOIN customer c ON c.CustomerID=g.CustomerID 
                                            WHERE u.BranchId=g.BranchId");
                                    ...
                                    <table  id="example1" class="table table-bordered table-striped">
                                        ...
                                        /* while ($row = mysql_fetch_array($sql)) 
                                          ...
                                          . "<td>".$row['ApplyLoanDate']."</td>"
                                          . "<td>".$row['AppliedAmount']."</td>"
                                          . "<td>".$row['ForDurationinMonth']."</td>";
                                          ...
                                          "<td><a href='view_customer_account.php?id=",$row['ApplyGoldLoanID'],"' '><span class='badge bg-blue'>View</span></a></td>"
                                          . "</tr>";
                                          } */
                                        ?> </table> <?php
                                        ?> 
