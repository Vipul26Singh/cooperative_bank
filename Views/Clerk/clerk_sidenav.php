             ...
             <a href="#">
               ...
               <span class="pull-right-container">
                 <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                       <li><a href="add_gold_loan.php"><i class="fa fa-inr"></i>Apply Gold Loan</a></li>
                       <li><a href="add_reguler_loan.php"><i class="fa fa-inr"></i>Apply Regular Loan</a></li>
                       <li><a href="approve_goldloan_list.php"><i class="fa fa-inr"></i> Gold Loan list</a></li>
                       <li><a href="approve_regulerloan_list.php"><i class="fa fa-inr"></i>Regular Loan List</a></li>
                    </ul>
           </li> -->
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="pending_loan_customer.php"><i class="fa fa-diamond"></i>Goald Loan</a></li>
                            <li><a href="pending_regulerloan_applicationList.php"><i class="fa fa-rupee"></i>Reguler Loan</a></li>
