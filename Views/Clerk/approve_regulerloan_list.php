                ...
                <section class="content">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">Approve Reguler Loan Customer</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <form role="form" method="post" action="">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php $sql = mysql_query("select * from loanapplication 
                                                where Approval='approve' and LoanStatus='approve' and BranchId='" . $_SESSION['branch_id'] . "' ") or die(mysql_error());
                                    ;
                                    ?><br>
                                    <table class="table table-responsive table-condensed table-striped table-hover table-bordered">
                                        ...
                                        while ($row = mysql_fetch_array($sql)) {
                                            ...
                                            /* . "<td><a href='grant_regulerloan_old.php?id=",$row['ApplyLoanID'],"' '><span class='badge bg-yellow'>View</span></a></td>" */
                                            . "</tr>";
                                        }
                                        ?> </table> <?php
