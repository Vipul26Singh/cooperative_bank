...
if (isset($_POST['submit'])) {
    ...
    if ($sql['Apassword'] != $_POST['oldpassword']) {
        ?><script>alert('Old password does not match.');</script><?php
    } else {
...
$sql = mysql_query("SELECT * FROM userinfo WHERE UserId ='" . $login_session_id . "' ") or die(mysql_error());
