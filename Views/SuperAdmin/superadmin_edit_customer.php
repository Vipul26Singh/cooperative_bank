...
if (isset($_REQUEST['submit'])) {
    ...
    $c_dob = date('Y-m-d', strtotime($_POST['cdob']));
    $cage = $_POST['cage'];
    ...
    $nname = $_POST['nname'];
    $nage = $_POST['nage'];
    $sdob = date('Y-m-d', strtotime($_POST['spdob']));
    ...
    ?>
                                    ...
                                    <div class="col-md-4 space"> 
                                        <select class="form-control" name="maritalstatus" style="width: 100%;">
                                            ...
                                            <option value="married" <?php if ($row['MartialStatus'] == "married") echo ' selected'; ?>>Married</option>
                                            <option value="single" <?php if ($row['MartialStatus'] == "single") echo ' selected'; ?>>Single</option>
                                            <option value="divorsed" <?php if ($row['MartialStatus'] == "divorsed") echo ' selected'; ?>>Divorsed</option>
                                            <option value="widow" <?php if ($row['MartialStatus'] == "widow") echo ' selected'; ?>>Widow</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2 space"> 
                                        <label>Pincode</label>
