...
if (isset($_POST['submit'])) {
    ...
    $sql = mysql_query("INSERT INTO `goldloantype`(`GName`, `Description`,`InterestRate`, `Durationinmonth`,  `Active`, `CreatedBy`, `CreatedDate` ) VALUES "
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Goal Loan Type</h3>
                        </div>
