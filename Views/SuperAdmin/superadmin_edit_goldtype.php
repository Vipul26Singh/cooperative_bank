...
if (isset($_REQUEST['submit'])) {
    ...
    $sql1 = mysql_query("UPDATE `goldloantype` SET `GName`='" . $g_name . "',`Description`='" . $g_desp . "',`InterestRate`='" . $g_rate . "',`Durationinmonth`='" . $g_durn . "', `Active`='" . $g_status . "',`ModifiedBy`='" . $login_session_id . "',`ModifiedDate`=CURTIME() WHERE GoldLoanTypeid ='" . $cid . "' ") or die(mysql_error());
    if ($sql1) {
        //echo "Successfully Updated";
        header("location: gold_loantype_list.php");
    }
}
?>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Gold Loan Type Detail</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>GoldLoan Type Name</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo $row['GName']; ?>" name="g_name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
