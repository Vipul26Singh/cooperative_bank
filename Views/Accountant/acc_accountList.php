                                ...
                                <div class="form-group">
                                    ...
                                    <table  id="example1" class="table table-bordered table-striped">
                                        ...
                                        while ($row = mysql_fetch_array($sql)) {
                                            ...
                                            "<td><a href='acc_view_account.php?id=", $row['AccountId'], "' '><span class='badge bg-yellow'>View</span></a></td>"
                                            . "</tr>";
                                        }
                                        ?> </table> <?php
                                        ?>
