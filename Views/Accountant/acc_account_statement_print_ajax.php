...
<body class="body">
    ...
    /*** Display Acc no and date **/
    else if($_GET['accountno'] && $_GET['trasactiondate'] && $_GET['trasactionenddate'] ){
    ...
    /*** Account no and cash ****/
    else if($_GET['accountno'] && $_GET['trasactionmode']){
    ...
    /*** Account No ***/
   else if($_GET['accountno'] && empty($_GET['trasactiondate'] && $_GET['trasactionenddate'] && $_GET['trasactionmode'])) 
    {
        $sqlaccount = mysql_query("SELECT * FROM  bankaccounttransactions WHERE accountNo='".$_GET['accountno']."' 
