        ...
        <div class="box-body">               
            <div class="col-md-12">
                <table class="table table-responsive table-condensed table-striped table-hover table-bordered">
                    ...
                    else if ($_POST['loanno'] && $_POST['trasaction_date'] && $_POST['trasaction_end_date']) {
...
?>  </table> 
        ...
        <div class="box-footer text-center">
            <button type="button" name="submit" class="btn btn-warning" value="Print" onclick="accountdetails()"><i class="fa fa-print"></i> Print</button> 				
        </div>
